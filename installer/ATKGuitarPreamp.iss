...
DefaultGroupName=ATKGuitarPreamp
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=ATKGuitarPreamp Installer
...
[Icons]
Name: "{group}\ATKGuitarPreamp"; Filename: "{app}\ATKGuitarPreamp.exe"
;Name: "{group}\User guide"; Filename: "{app}\GuitarPreamp_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
;Name: "{group}\readme"; Filename: "{app}\readme.rtf"
Name: "{group}\Uninstall ATKGuitarPreamp"; Filename: "{app}\unins000.exe"
